...
# installed.
TK_PREFIX='/Users/yogeshdewangan/Desktop/Machine Learning/DimondPricePrediction/venv1'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/yogeshdewangan/Desktop/Machine Learning/DimondPricePrediction/venv1'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/yogeshdewangan/Desktop/Machine Learning/DimondPricePrediction/venv1/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/yogeshdewangan/Desktop/Machine Learning/DimondPricePrediction/venv1/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/yogeshdewangan/Desktop/Machine Learning/DimondPricePrediction/venv1/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/yogeshdewangan/Desktop/Machine Learning/DimondPricePrediction/venv1/lib/libtkstub8.6.a'
